...
- Does webhook signature verification fail closed (reject unverified payloads) rather than fail open? See [webhook verification issue](ISSUES.md#high) for context.
